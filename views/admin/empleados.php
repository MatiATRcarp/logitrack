    ...
    elseif ($accion === 'rendimiento') {
        ...
        if (!$id || !$periodo || $puntaje < 1 || $puntaje > 100) {
            ...
            $pdo->prepare("
                ...
                VALUES ('empleado', :id, :periodo, :puntaje, :observacion)
...
$sql = "
    ...
    LEFT   JOIN rendimiento_personal rp ON rp.id_rendimiento = (
        ...
        WHERE rp2.tipo_personal = 'empleado'
          AND rp2.id_personal = e.id_empleado
...
<div class="layout">
    ...
    <main class="main-content">
        ...
        <div class="tabla-wrapper">
            <table>
                <thead>
                    <tr><th>DNI</th><th>Nombre</th><th>Legajo</th><th>Sucursal</th><th>Email</th><th>Rendimiento</th><th>Estado</th><th>Acciones</th></tr>
                </thead>
                <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?= $e['rendimiento_puntaje'] !== null
                            ? '<span class="badge badge-activo">' . (int) $e['rendimiento_puntaje'] . '/100</span>'
                    ...
                    <td style="display:flex;gap:6px;flex-wrap:wrap;">
                        ...
                        <a href="#rend-empleado-<?= $e['id_empleado'] ?>" class="btn-sm btn-edit">Rendimiento</a>
                        <a href="#del-empleado-<?= $e['id_empleado'] ?>" class="btn-sm btn-delete">Eliminar</a>
                        <div class="modal-overlay" id="rend-empleado-<?= $e['id_empleado'] ?>">
                            <div class="modal-box modal-box-edit">
                                ...
                                <form method="POST" action="/logitrack/views/admin/empleados.php">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group">
                                            <label>Período</label>
                                            <input type="month" name="periodo" value="<?= $e['rendimiento_periodo'] ? date('Y-m', strtotime($e['rendimiento_periodo'])) : date('Y-m') ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Puntaje</label>
                                            <input type="number" name="puntaje" min="1" max="100" value="<?= htmlspecialchars($e['rendimiento_puntaje'] ?? '') ?>" required>
                                        </div>
                                        <div class="form-group full">
                ...
                <tr><td colspan="8" style="text-align:center;color:var(--gris);padding:32px;">Sin empleados registrados</td></tr>
                <?php endif; ?>
                </tbody>
            </table>
        </div>
