                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (($env['estado_nombre'] ?? '') === 'En tránsito'): ?>
                                <div class="acciones-carga">
                                    <form method="POST" action="/logitrack/controllers/ChoferController.php?action=verificarPaquete" style="margin:0;">
                                        ...
                                        <button type="submit" class="btn-entregar"
                                                onclick="return confirm('¿El paquete llegó íntegro a la sucursal destino?')">
                                            ✅ Verificar OK
                                        </button>
                                    </form>
                                    <form method="POST" action="/logitrack/controllers/ChoferController.php?action=verificarPaquete" style="margin:0;">
                                        <input type="hidden" name="id_envio" value="<?= (int) $env['id_envio'] ?>">
                                        <input type="hidden" name="resultado" value="roto">
                                        <button type="submit" class="btn btn-danger btn-sm"
                                                onclick="return confirm('¿Marcar paquete roto y devolverlo al remitente?')">
                                            Roto
                                        </button>
                                    </form>
                                </div>
                                <?php elseif (($env['estado_nombre'] ?? '') === 'Ingresado en sucursal destino'): ?>
                                <form method="POST"
