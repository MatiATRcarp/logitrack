...
-- Confirma la entrega de un envío (id_estado = 4).
-- Verifica que el estado actual sea 2 (En Tránsito) o 3 (En sucursal destino).
-- ─────────────────────────────────────────────────────────────────────
...
BEGIN
    ...
    ELSE
        INSERT INTO historial_estado (id_envio, id_estado, fecha_hora, id_sucursal_actual)
        VALUES (p_id_envio, 4, NOW(), p_id_sucursal);
