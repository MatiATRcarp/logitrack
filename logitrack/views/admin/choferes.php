...
<div class="layout">
    ...
    <main class="main-content">
        ...
        <div class="tabla-wrapper">
            <table>
                <thead>
                    <tr><th>DNI</th><th>Nombre</th><th>Email</th><th>Legajo</th><th>Licencia</th><th>Estado</th><th>Acciones</th></tr>
                </thead>
                <tbody>
                ...
                <tr><td colspan="7" style="text-align:center;color:var(--gris);padding:32px;">Sin choferes registrados</td></tr>
                <?php endif; ?>
                </tbody>
            </table>
        </div>
